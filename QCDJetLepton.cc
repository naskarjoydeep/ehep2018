...
int main(int argc, char* argv[]) {
  ...
  TApplication theApp("QCDjets", &argc, argv);
 ...
 // Create file on which histogram(s) can be saved.
  TFile* outFile1 = new TFile("QCDnJetsS.root", "RECREATE");
  //TFile* outFile2 = new TFile("QCDnJetsC.root", "RECREATE");
  //TFile* outFile3 = new TFile("QCDnJetsD.root", "RECREATE");
  TFile* outFile4 = new TFile("QCDpTJetsS.root", "RECREATE");
  //TFile* outFile5 = new TFile("QCDeTJetsC.root", "RECREATE");
  TFile* outFile6 = new TFile("QCDyJetsS.root", "RECREATE");
  //TFile* outFile7 = new TFile("QCDetaJetsC.root", "RECREATE");
  TFile* outFile8 = new TFile("QCDphiJetsS.root", "RECREATE");
  //TFile* outFile9 = new TFile("QCDphiJetsC.root", "RECREApTTE");
  TFile* outFile10 = new TFile("QCDdistJetsS.root", "RECREATE");
  //TFile* outFile11 = new TFile("QCDdistJetsC.root", "RECREATE");
  TFile* outFile12 = new TFile("QCDpTdiffS.root", "RECREATE");
  //TFile* outFile13 = new TFile("QCDeTdiffC.root", "RECREATE");
  TFile* outFile14 = new TFile("QCDnLeptons.root", "RECREATE");
  TFile* outFile15 = new TFile("QCDLeptonpT.root", "RECREATE");
  TFile* outFile16 = new TFile("QCDLeptonEta.root", "RECREATE");
  TFile* outFile17 = new TFile("QCDMET.root", "RECREATE");


// Book histogram.
  TH1F *nJetsS = new TH1F("QCDnJetsS","QCD number of jets, SlowJet", 50, -0.5, 49.5);
  //TH1F *nJetsC = new TH1F("QCDnJetsC","QCD number of jets, CellJet", 50, -0.5, 49.5);
  //TH1F *nJetsD = new TH1F("QCDnJetsD","QCD number of jets, CellJet - SlowJet", 45, -22.5, 22.5);
  TH1F *pTJetsS = new TH1F("QCDpTJetsS","QCD pT for jets, SlowJet", 100, 0., 250.);
  //TH1F *eTJetsC = new TH1F("QCDeTJetsC","QCD eT for jets, CellJet", 100, 0., 250.);
  TH1F *yJetsS = new TH1F("QCDyJetsS","QCD y for jets, SlowJet", 100, -5., 5.);
  //TH1F *etaJetsC = new TH1F("QCDyJetsC","QCD eta for jets, CellJet", 100, -5., 5.);
  TH1F *phiJetsS = new TH1F("QCDphiJetsS","QCD phi for jets, SlowJet", 100, -M_PI, M_PI);
  //TH1F *phiJetsC = new TH1F("QCDphiJetsC","QCD phi for jets, CellJet", 100, -M_PI, M_PI);
  TH1F *distJetsS = new TH1F("QCDdistJetsS","QCD R distance between jets, SlowJet", 100, 0., 10.);
  //TH1F *distJetsC = new TH1F("QCDdistJetsC","QCD R distance between jets, CellJet", 100, 0., 10.);
 
  //TH1F *eTdiffC = new TH1F("QCDeTdiffC","QCD eT difference, CellJet", 100, -100., 400.);
  TH1F *nLepton = new TH1F("QCDnLepton","QCD number of leptons", 20, -0.5, 19.5);
  //TH1F *m0JetsC = new TH1F("QCDm0","QCD Invariant Mass of Jets, CellJet", 100, 0., 1000.);
  TH1F *pTLepton = new TH1F("QCDpTLepton","QCD pT of Leptons", 100, 0., 250.);
  TH1F *etaLepton = new TH1F("QCDetaLepton","QCD eta of Leptons", 20, -10., 10.);
  TH1F *MET = new TH1F("QCDMET","QCD Missing Energy", 100, 0., 100.);
  TH1F *pTdiffS = new TH1F("QCDpTdiffS","QCD pT difference, SlowJet", 100, -100., 400.);
