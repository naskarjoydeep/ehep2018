...
int main(int argc, char* argv[]) {
  ...
  TApplication theApp("DYjets", &argc, argv);
 ...
 // Create file on which histogram(s) can be saved.
  TFile* outFile1 = new TFile("DYnJetsS.root", "RECREATE");
  //TFile* outFile2 = new TFile("DYnJetsC.root", "RECREATE");
  //TFile* outFile3 = new TFile("DYnJetsD.root", "RECREATE");
  TFile* outFile4 = new TFile("DYpTJetsS.root", "RECREATE");
  //TFile* outFile5 = new TFile("DYeTJetsC.root", "RECREATE");
  TFile* outFile6 = new TFile("DYyJetsS.root", "RECREATE");
  //TFile* outFile7 = new TFile("DYetaJetsC.root", "RECREATE");
  TFile* outFile8 = new TFile("DYphiJetsS.root", "RECREATE");
  //TFile* outFile9 = new TFile("DYphiJetsC.root", "RECREApTTE");
  TFile* outFile10 = new TFile("DYdistJetsS.root", "RECREATE");
  //TFile* outFile11 = new TFile("DYdistJetsC.root", "RECREATE");
 
  //TFile* outFile13 = new TFile("DYeTdiffC.root", "RECREATE");
  TFile* outFile14 = new TFile("DYnLeptons.root", "RECREATE");
  TFile* outFile15 = new TFile("DYLeptonpT.root", "RECREATE");
  TFile* outFile16 = new TFile("DYLeptonEta.root", "RECREATE");
  TFile* outFile17 = new TFile("DYMET.root", "RECREATE");
  TFile* outFile12 = new TFile("DYpTdiffS.root", "RECREATE");

// Book histogram.
  TH1F *nJetsS = new TH1F("DYnJetsS","DY number of jets, SlowJet", 50, -0.5, 49.5);
  //TH1F *nJetsC = new TH1F("DYnJetsC","DY number of jets, CellJet", 50, -0.5, 49.5);
  //TH1F *nJetsD = new TH1F("DYnJetsD","DY number of jets, CellJet - SlowJet", 45, -22.5, 22.5);
  TH1F *pTJetsS = new TH1F("DYpTJetsS","DY pT for jets, SlowJet", 100, 0., 250.);
  //TH1F *eTJetsC = new TH1F("DYeTJetsC","DY eT for jets, CellJet", 100, 0., 250.);
  TH1F *yJetsS = new TH1F("DYyJetsS","DY y for jets, SlowJet", 100, -5., 5.);
  //TH1F *etaJetsC = new TH1F("DYyJetsC","DY eta for jets, CellJet", 100, -5., 5.);
  TH1F *phiJetsS = new TH1F("DYphiJetsS","DY phi for jets, SlowJet", 100, -M_PI, M_PI);
  //TH1F *phiJetsC = new TH1F("DYphiJetsC","DY phi for jets, CellJet", 100, -M_PI, M_PI);
  TH1F *distJetsS = new TH1F("DYdistJetsS","DY R distance between jets, SlowJet", 100, 0., 10.);
  //TH1F *distJetsC = new TH1F("DYdistJetsC","DY R distance between jets, CellJet", 100, 0., 10.);
  
  //TH1F *eTdiffC = new TH1F("DYeTdiffC","DY eT difference, CellJet", 100, -100., 400.);
  TH1F *nLepton = new TH1F("DYnLepton","DY number of leptons", 20, -0.5, 19.5);
  //TH1F *m0JetsC = new TH1F("DYm0","DY Invariant Mass of Jets, CellJet", 100, 0., 1000.);
  TH1F *pTLepton = new TH1F("DYpTLepton","DY pT of Leptons", 100, 0., 250.);
  TH1F *etaLepton = new TH1F("DYetaLepton","DY eta of Leptons", 20, -10., 10.);
  TH1F *MET = new TH1F("DYMET","DY Missing Energy", 100, 0., 100.);
  TH1F *pTdiffS = new TH1F("DYpTdiffS","DY pT difference, SlowJet", 100, -100., 400.);
