...
TH1D* h2 = (TH1D*)DY->Get("DYMET"); 
TH1D* h5 = (TH1D*)ttbar->Get("ttbarMET");
TH1D* h3 = (TH1D*)QCD->Get("QCDMET");
TH1D* h9 = (TH1D*)ZZ->Get("ZZMET");
TH1D* h8 = (TH1D*)ZW->Get("ZWMET");
TH1D* h7 = (TH1D*)WW->Get("WWMET");
TH1D* h4 = (TH1D*)SingleTop->Get("SingleTopMET");

THStack *MET = new THStack("LeptonEta","Lepton Pseudorapidity");
