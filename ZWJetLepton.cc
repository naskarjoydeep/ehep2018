...
int main(int argc, char* argv[]) {
  ...
  TApplication theApp("ZWjets", &argc, argv);
  ...
  double radius   = 0.7;
  double pTjetMin = 10.;
  // Exclude neutrinos (and other invisible) from stuZW.
  int    nSel     = 2;
 ...
 // Create file on which histogram(s) can be saved.
  TFile* outFile1 = new TFile("ZWnJetsS.root", "RECREATE");
  //TFile* outFile2 = new TFile("ZWnJetsC.root", "RECREATE");
  //TFile* outFile3 = new TFile("ZWnJetsD.root", "RECREATE");
  TFile* outFile4 = new TFile("ZWpTJetsS.root", "RECREATE");
  //TFile* outFile5 = new TFile("ZWeTJetsC.root", "RECREATE");
  TFile* outFile6 = new TFile("ZWyJetsS.root", "RECREATE");
  //TFile* outFile7 = new TFile("ZWetaJetsC.root", "RECREATE");
  TFile* outFile8 = new TFile("ZWphiJetsS.root", "RECREATE");
  //TFile* outFile9 = new TFile("ZWphiJetsC.root", "RECREApTTE");
  TFile* outFile10 = new TFile("ZWdistJetsS.root", "RECREATE");
  //TFile* outFile11 = new TFile("ZWdistJetsC.root", "RECREATE");
  TFile* outFile12 = new TFile("ZWpTdiffS.root", "RECREATE");
  //TFile* outFile13 = new TFile("ZWeTdiffC.root", "RECREATE");
  TFile* outFile14 = new TFile("ZWnLeptons.root", "RECREATE");
  TFile* outFile15 = new TFile("ZWLeptonpT.root", "RECREATE");
  TFile* outFile16 = new TFile("ZWLeptonEta.root", "RECREATE");
  TFile* outFile17 = new TFile("ZWMET.root", "RECREATE");


// Book histogram.
  TH1F *nJetsS = new TH1F("ZWnJetsS","ZW number of jets, SlowJet", 50, -0.5, 49.5);
  //TH1F *nJetsC = new TH1F("ZWnJetsC","ZW number of jets, CellJet", 50, -0.5, 49.5);
  //TH1F *nJetsD = new TH1F("ZWnJetsD","ZW number of jets, CellJet - SlowJet", 45, -22.5, 22.5);
  TH1F *pTJetsS = new TH1F("ZWpTJetsS","ZW pT for jets, SlowJet", 100, 0., 250.);
  //TH1F *eTJetsC = new TH1F("ZWeTJetsC","ZW eT for jets, CellJet", 100, 0., 250.);
  TH1F *yJetsS = new TH1F("ZWyJetsS","ZW y for jets, SlowJet", 100, -5., 5.);
  //TH1F *etaJetsC = new TH1F("ZWyJetsC","ZW eta for jets, CellJet", 100, -5., 5.);
  TH1F *phiJetsS = new TH1F("ZWphiJetsS","ZW phi for jets, SlowJet", 100, -M_PI, M_PI);
  //TH1F *phiJetsC = new TH1F("ZWphiJetsC","ZW phi for jets, CellJet", 100, -M_PI, M_PI);
  TH1F *distJetsS = new TH1F("ZWdistJetsS","ZW R distance between jets, SlowJet", 100, 0., 10.);
  //TH1F *distJetsC = new TH1F("ZWdistJetsC","ZW R distance between jets, CellJet", 100, 0., 10.);
  TH1F *pTdiffS = new TH1F("ZWpTdiffS","ZW pT difference, SlowJet", 100, -100., 400.);
  //TH1F *eTdiffC = new TH1F("ZWeTdiffC","ZW eT difference, CellJet", 100, -100., 400.);
  TH1F *nLepton = new TH1F("ZWnLepton","ZW number of leptons", 20, -0.5, 19.5);
  //TH1F *m0JetsC = new TH1F("ZWm0","ZW Invariant Mass of Jets, CellJet", 100, 0., 1000.);
  TH1F *pTLepton = new TH1F("ZWpTLepton","ZW pT of Leptons", 100, 0., 250.);
  TH1F *etaLepton = new TH1F("ZWetaLepton","ZW eta of Leptons", 20, -10., 10.);
  TH1F *MET = new TH1F("ZWMET","ZW Missing Energy", 100, 0., 100.);
